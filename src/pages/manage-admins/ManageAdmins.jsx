...
export const ManageAdmins = () => {
  ...
  const getAllAdmins = async () => {
    ...
    const response = await fetch(
      `${baseUrl}/api/v1/users/get-users-by-role-admin`,
      {
        method: "GET",
        headers: {
    ...
    console.log("ALL ADMINS FROM BACKEND", res.data.users);
  ...
  const {
    ...
    data: AdminInfo,
    error,
  } = useQuery({ queryKey: ["admins"], queryFn: getAllAdmins });
    ...
    <div className={styles["manage-container"]}>
      <span className={styles["tokens-header"]}>
        ...
        <span className={styles["tokens-desc"]}>
          These monitor and manage all resources on the entire site.
        </span>
      </span>
      <div className={styles["listContainer"]}>
        <div className={styles["admin-header-container"]}>
          <div className={styles["listTitle"]}>Admins</div>
          <form
